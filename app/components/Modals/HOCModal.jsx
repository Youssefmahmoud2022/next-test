...
const HOCModal = (Component) => {
  ...
  return (props) => {
    ...
    let {showModal,title,imgsArray,videoicon} = props;
    ...
    return (
      <>
        ...
        <button className={`mt-3 h-[50px] px-3 textColor flex items-center justify-center gap-1 border-[1px] border-[#484868] rounded-md p-2`} onClick={toggleModalFunc}>
